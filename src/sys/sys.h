...
// 检测与分析类
void biz_start_gas_wave_scan(uint8_t Leaser_pin_1, uint8_t Leaser_pin_2, uint8_t Leaser_pin_3); // 气体波形扫描 (需传入GPIO引脚)
void biz_start_point_knobs(uint8_t Leaser_pin_1, uint8_t Leaser_pin_2, uint8_t Leaser_pin_3);          // 旋钮指向/分析
...
void biz_start_blow_box(uint8_t Leaser_pin_1, uint8_t Leaser_pin_2, uint8_t Leaser_pin_3);            // 蓄力爆炸效果
